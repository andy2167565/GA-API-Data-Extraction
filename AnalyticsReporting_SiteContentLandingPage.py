...
print('-----------< Site Content_Landing Page >-----------')
...
filename = 'Site_Content_Landing_Page.csv'

if not os.path.exists(filepath):
    os.makedirs(filepath)

# GA parameters of metrics and dimensions
metrics_list = [{'expression': 'ga:sessions'}, {'expression': 'ga:percentNewSessions'},
                {'expression': 'ga:newUsers'}, {'expression': 'ga:bounceRate'},
                {'expression': 'ga:pageviewsPerSession'}, {'expression': 'ga:avgSessionDuration'}]
dimensions_list = [{'name': 'ga:date'}, {'name': 'ga:landingPagePath'},
                   {'name': 'ga:channelGrouping'}]
metrics_dimensions_list = [[metrics_list, dimensions_list]]

# Headers for csv output
header_row = ['Date', 'Landing_Page', 'Default_Channel_Grouping', 'Sessions', '%_New_Sessions',
              'New_Users', 'Bounce_Rate', 'Pages_Session', 'Avg_Session_Duration']
