...
print('------< Frequency_Recency_Count of Session >-------')
...
filename = 'Frequency_Recency_Count_of_Session.csv'
...
dimensions_list = [{'name': 'ga:date'}, {'name': 'ga:sessionCount'}]
metrics_dimensions_list = [[metrics_list, dimensions_list]]

# Headers for csv output
header_row = ['Date', 'Count_of_Sessions', 'Sessions', 'Pageviews']
