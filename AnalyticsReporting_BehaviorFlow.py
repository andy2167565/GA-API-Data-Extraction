...
filename = 'Behavior_Flow.csv'

if not os.path.exists(filepath):
    os.makedirs(filepath)

# GA parameters of metrics and dimensions
metrics_list = [{'expression': 'ga:sessions'}]
dimensions_list = [{'name': 'ga:date'}, {'name': 'ga:source'},
                   {'name': 'ga:medium'}, {'name': 'ga:landingPagePath'},
                   {'name': 'ga:secondPagePath'}, {'name': 'ga:exitPagePath'}]
metrics_dimensions_list = [[metrics_list, dimensions_list]]

# Headers for csv output
header_row = ['Date', 'Source', 'Medium', 'Landing_Page', 'Second_Page', 'Exit_Page', 'Sessions']
