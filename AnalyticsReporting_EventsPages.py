...
filename = 'Events_Pages.csv'

if not os.path.exists(filepath):
    os.makedirs(filepath)

# GA parameters of metrics and dimensions
metrics_list = [{'expression': 'ga:totalEvents'}, {'expression': 'ga:uniqueEvents'},
                {'expression': 'ga:eventValue'}, {'expression': 'ga:sessionsWithEvent'},
...
header_row = ['Date', 'Page', 'Total_Events', 'Unique_Events',
              'Event_Value', 'Sessions_with_Event', 'Events_Session_with_Event']
