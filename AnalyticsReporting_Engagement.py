...
metrics_list = [{'expression': 'ga:sessionDuration'}, {'expression': 'ga:sessions'},
                {'expression': 'ga:pageviews'}]
dimensions_list = [{'name': 'ga:date'}, {'name': 'ga:pageDepth'}]
metrics_dimensions_list = [[metrics_list, dimensions_list]]

# Headers for csv output
header_row = ['Date', 'Page_Depth', 'Session_Duration', 'Sessions', 'Pageviews']
