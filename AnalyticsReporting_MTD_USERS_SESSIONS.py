...
filename = 'MTD_USERS_SESSIONS.csv'

if not os.path.exists(filepath):
    os.makedirs(filepath)

# GA parameters of metrics and dimensions
metrics_list = [{'expression': 'ga:users'}, {'expression': 'ga:sessions'}]
dimensions_list = [{'name': 'ga:yearMonth'}]
metrics_dimensions_list = [[metrics_list, dimensions_list]]

# Headers for csv output
header_row = ['yearMonth', 'Users', 'Sessions']
